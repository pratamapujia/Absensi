  ...
  <div class="section mt-2">
    <div class="profile-head">
      <div class="avatar">
        ...
        @else
        <img src="assets/img/default.png" alt="avatar" class="imaged w64 rounded">
        @endif
      </div>
      <div class="in">
          ...
          <div class="card-body comment-block">
            <div class="item">
              ...
              <div class="in">
                ...
                <div class="text">
                  Bulan Ini : <span class="badge rounded-pill bg-danger">{{ $rekapPresensi->jmlHadir == '' ? 0 : $rekapPresensi->jmlHadir }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body comment-block">
            <div class="item">
              ...
              <div class="in">
                ...
                <div class="text">
                  Bulan Ini : <span class="badge rounded-pill bg-danger">{{ $rekapPresensi->jmlTerlambat == '' ? 0 : $rekapPresensi->jmlTerlambat }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body comment-block">
            <div class="item">
              ...
              <div class="in">
                ...
                <div class="text">
                  Bulan Ini : <span class="badge rounded-pill bg-danger">{{ $rekapIjin->izin == '' ? 0 : $rekapIjin->izin }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body comment-block">
            <div class="item">
              ...
              <div class="in">
                ...
                <div class="text">
                  Bulan Ini : <span class="badge rounded-pill bg-danger">{{ $rekapIjin->sakit == '' ? 0 : $rekapIjin->sakit }}</span>
                </div>
              </div>
            </div>
          </div>
