          ...
          <div class="card-body px-4 py-4-5">
            <div class="row">
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-7">
                ...
                <h6 class="font-extrabold mb-0">{{ $rekapPresensi->jmlHadir == '' ? 0 : $rekapPresensi->jmlHadir }}</h6>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body px-4 py-4-5">
            <div class="row">
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-7">
                ...
                <h6 class="font-extrabold mb-0">{{ $rekapPresensi->jmlTerlambat == '' ? 0 : $rekapPresensi->jmlTerlambat }}</h6>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body px-4 py-4-5">
            <div class="row">
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-7">
                ...
                <h6 class="font-extrabold mb-0">{{ $rekapIzin->izin == '' ? 0 : $rekapIzin->izin }}</h6>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body px-4 py-4-5">
            <div class="row">
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-7">
                ...
                <h6 class="font-extrabold mb-0">{{ $rekapIzin->sakit == '' ? 0 : $rekapIzin->sakit }}</h6>
              </div>
            </div>
          </div>
        </div>
