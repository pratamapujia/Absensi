          ...
          <div class="card-body py-4 px-4">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3 name w-100">
                ...
                <h3 class="text-muted mb-2">110</h3>
                <div class="progress progress-info progress-sm mb-4">
                  <div class="progress-bar w-100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span>Total semua akun yang terdaftar</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body py-4 px-4">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3 name w-100">
                ...
                <h3 class="text-muted mb-2"><?= $totalKelas; ?></h3>
                <div class="progress progress-danger progress-sm mb-4">
                  <div class="progress-bar w-100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span>Total semua kelas dari <?= $totalJurusan; ?> jurusan</span>
              </div>
            </div>
          </div>
        </div>
